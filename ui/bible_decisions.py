"""
bible_decisions.py — Onglet Décisions d'auteur de la Bible
"""
...
class BibleDecisionsWidget(QWidget):
    """Onglet Décisions d'auteur."""
    ...
    def _setup_ui(self):
        ...
        self._empty_hint = QLabel("Aucune décision d'auteur dans la Bible.\nL'Archiviste les détecte automatiquement.")
        ...
        self._table.setHorizontalHeaderLabels(["Décision", "Détail", ""])
    ...
    def refresh(self, bible_db: BibleDB) -> None:
        ...
        rows = bible_db.get_all("decisions")
        if not rows:
            self._table.hide()
    ...
    def _delete(self, label: str) -> None:
        ...
        if reply == QMessageBox.StandardButton.Yes:
            self._bible_db.delete("decisions", label)
