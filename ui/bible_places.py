"""
bible_places.py — Onglet Lieux de la Bible
"""
...
class BiblePlacesWidget(QWidget):
    """Onglet Lieux — tableau label / description."""
    ...
    def _setup_ui(self):
        ...
        self._table.setHorizontalHeaderLabels(["Lieu", "Description", ""])
    ...
    def _delete(self, label: str) -> None:
        ...
        if reply == QMessageBox.StandardButton.Yes:
            self._bible_db.delete("places", label)
